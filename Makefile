# This Makefile is for the Maypole::Plugin::Relationship extension to perl.
#
...
#     NAME => q[Maypole::Plugin::Relationship]
#     PREREQ_PM => { Class::DBI::Loader::Relationship=>q[0], Maypole=>q[2.0] }
#     VERSION_FROM => q[Relationship.pm]
...
NAME_SYM = Maypole_Plugin_Relationship
VERSION = 0.03
...
FULLEXT = Maypole/Plugin/Relationship
BASEEXT = Relationship
...
TO_INST_PM = Relationship.pm

PM_TO_BLIB = Relationship.pm \
	$(INST_LIB)/Maypole/Plugin/Relationship.pm
...
DISTNAME = Maypole-Plugin-Relationship
DISTVNAME = Maypole-Plugin-Relationship-0.03
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3pm --perm_rw=$(PERM_RW)\
	  Relationship.pm $(INST_MAN3DIR)/Maypole::Plugin::Relationship.$(MAN3EXT) 
...
realclean purge ::  clean realclean_subdirs
	...
	$(RM_RF) $(DISTVNAME)
	$(RM_F)  $(INST_LIB)/Maypole/Plugin/Relationship.pm $(MAKEFILE_OLD) $(FIRST_MAKEFILE)
...
metafile :
	...
	$(NOECHO) $(ECHO) 'name:         Maypole-Plugin-Relationship' >> META.yml
	$(NOECHO) $(ECHO) 'version:      0.03' >> META.yml
	$(NOECHO) $(ECHO) 'version_from: Relationship.pm' >> META.yml
...
pm_to_blib: $(TO_INST_PM)
	$(NOECHO) $(PERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')'\
	  Relationship.pm $(INST_LIB)/Maypole/Plugin/Relationship.pm 
	$(NOECHO) $(TOUCH) $@
